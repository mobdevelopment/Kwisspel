...
namespace QuizGamePack.Model
{
    class DummyQuestionRepository : IQuestionRepository
    {
        public List<Question> ToList()
        {
            ...
            questions.Add(new Question { Id = 1, Text = "Wat is 1 + 1", Category = "Rekenen", Answers = new List<Answer> {
                new Answer { Id = 1, Text = "2", IsCorrect = true},
                new Answer { Id = 2, Text = "11", IsCorrect = false}
            } });

            questions.Add(new Question { Id = 2, Text = "Wat is 2 + 2", Category = "Rekenen", Answers = new List<Answer> { 
            ...
            questions.Add(new Question { Id = 3, Text = "Wat is liefde", Category = "Rekenen", Answers = new List<Answer> { 
            ...
            questions.Add(new Question { Id = 4, Text = "Welke programmeertaal is cewl?", Category = "Rekenen", Answers = new List<Answer> {
